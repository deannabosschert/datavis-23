  ...
  <section id="stats-2" v-if="showStats2">
    <transition name="fade">
      <article>
        <div>
          <h3>Wie zijn dit?</h3>
          <p>Zou je als {{ brand }}-liefhebber ook meer voorkeur kunnen hebben voor een bepaalde CMD-richting? Hebben jullie een gedeelde passie in iets?</p>
